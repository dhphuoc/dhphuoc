...
def loggin():
    ...
    try:
        ...
        try:
            ...
            try:
                WebDriverWait(driver, 10).until(
                    EC.presence_of_element_located((By.CSS_SELECTOR, "body > div:nth-child(11) > div > div.noscriptcheck > div > div > div:nth-child(6) > div > button"))
                )
                js_script = '''
                ...
                WebDriverWait(driver, 10).until(
                    EC.presence_of_element_located((By.CSS_SELECTOR, "body > div:nth-child(10) > div > div.noscriptcheck > div > div > div:nth-child(6) > div > button"))
                )
                js_script = '''
...
while True:
    ...
    try:
        ...
        try:
            WebDriverWait(driver, 10).until(
                EC.presence_of_element_located((By.CSS_SELECTOR, '#c2VuZC9mb2xeb3dlcnNfdGlrdG9V > div'))
            )
            driver.refresh()
            loggin()
        except:
